...
class ModbusMaster
{
  ...
  private:
    ...
    uint16_t _frameEnd; ///< in microseconds
    uint16_t _RTUFrameGap; ///< in microseconds - The start of a frame is defined as no transmission for 3.5 character periods
    uint32_t _u32SerialBaudrate = 9600;
